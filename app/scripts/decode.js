    ...
    _.each(buzzfeed.commentArr, function (e, i, l) {
      ...
      if (e.form == "badge_vote" || e.form == "loves" || e.form == "hates") {
        ...
        //they're new to the party, put their info on the page
          ...
          $('#reactionAll').attr('id',"reactionAll"+buzzfeed.allCommentCount);
          var output2 = document.getElementById("reactionAll"+buzzfeed.allCommentCount);
          output2.innerHTML =   output2.innerHTML + buzzfeed.innerReactionStrAll;
          reactionIndAll=0
          currCommentId = 'reactionAll'+buzzfeed.allCommentCount
          $('#reactionAll'+buzzfeed.allCommentCount).render(e, reactionDirectives);
          console.log("spawning " + currCommentId)
        }
      ...
      if (buzzfeed.allCommentCount > buzzfeed.DISPLAY_NUM && currCommentId != "") {
        console.log("hiding " +currCommentId )
        //$("#"+currCommentId).hide()
